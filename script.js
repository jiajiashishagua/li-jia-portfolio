...
const shortDramaSections = [
  {
    ...
    eyebrow: "PART 01",
    title: "Mad Queen",
    summary: "EP29 / Web Preview",
    description: "EP29 代表性精简样片，用于展示短剧镜头调度、人物状态和高密度剧情推进能力。",
    files: [
      {
        id: "ep29",
        title: "Mad Queen // EP29 代表样片",
        fileName: "mad-queen-ep29-demo.mp4",
        type: "video/mp4",
        role: "职责：剧情理解、人物状态拆解、镜头节奏与画面质量优化",
        proof: "能力证明：能把高密度情绪冲突转译成可生成、可质检、可交付的镜头方案。",
        src: "assets/short-drama/demo/mad-queen-ep29-demo.mp4",
        available: true,
        confidential: true,
      },
    ],
  },
  {
    ...
    summary: "EP30 / Web Preview",
    description: "EP30 代表性精简样片，用于呈现连续叙事、人物关系变化、情绪反转和短剧节奏控制。",
    files: [
      {
        id: "ep30",
        title: "Second Chance // EP30 代表样片",
        fileName: "second-chance-ep30-demo.mp4",
        type: "video/mp4",
        role: "职责：叙事节奏拆解、二卡/三卡制作、分镜提示词优化",
        proof: "能力证明：能围绕人物反转和平台节奏，拆出更适合 AIGC 生产的画面结构。",
        src: "assets/short-drama/demo/second-chance-ep30-demo.mp4",
        available: true,
        confidential: true,
      },
    ],
  },
  {
    ...
    summary: "EP36 / Web Preview",
    description: "EP36 代表性精简样片，用于展示出海短剧项目中的叙事节奏、情绪钩子和画面交付能力。",
    files: [
      {
        id: "ep36",
        title: "My Husband Lost Me // EP36 代表样片",
        fileName: "my-husband-lost-me-ep36-demo.mp4",
        type: "video/mp4",
        role: "职责：剧情钩子提炼、人物关系拆解、成片问题复盘",
        proof: "能力证明：能在出海短剧语境下平衡情绪强度、镜头清晰度与交付稳定性。",
        src: "assets/short-drama/demo/my-husband-lost-me-ep36-demo.mp4",
        available: true,
        confidential: true,
      },
    ],
